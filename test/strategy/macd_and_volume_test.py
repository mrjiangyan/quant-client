...
class TestStrategy(bt.Strategy):
    ...
    def calculate_and_log_volume_averages(self):
        # 计算10天、30天和100天的平均成交量
        avg_vol_10 = bt.indicators.SimpleMovingAverage(self.data.volume, period=10)
        avg_vol_30 = bt.indicators.SimpleMovingAverage(self.data.volume, period=30)
        avg_vol_100 = bt.indicators.SimpleMovingAverage(self.data.volume, period=100)
        ...
        # 打印日志
        self.log(f'日期: {date}, 当前成交量: {current_vol}, 10天平均成交量: {avg_vol_10[0]}, 30天平均成交量: {avg_vol_30[0]}, 100天平均成交量: {avg_vol_100[0]}')
